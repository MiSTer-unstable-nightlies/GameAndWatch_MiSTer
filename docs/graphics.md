...
* The first value `x` represents which segment lines are used. `0 -> seg_a`, `1 -> seg_b`, `2 -> seg_bs`, `3 -> seg_c`
* The second value `y` is the column of the data, or the bit in the `seg_a/b/bs/c` line

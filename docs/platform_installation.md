...
ROMs must be generated from their MAME counterparts. The generator source is included in [`rom generator/`](../rom%20generator); see [ROM Generator](rom_generator.md) for more information.
